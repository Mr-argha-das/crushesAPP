...
class _HomeService implements HomeService {
  ...
  @override
  Future<UserMatchResModel> userMatches() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserMatchResModel>(
    ...
    late UserMatchResModel _value;
    try {
      _value = UserMatchResModel.fromJson(_result.data!);
    } on Object catch (e, s) {
